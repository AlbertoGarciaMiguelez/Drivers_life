...
### Flujo del juego
El flujo de juego de _Drivers Life_ es totalmente lo opuesto a un juego lineal clásico, en ningún momento tendremos que seguir una especie de misiones guiadas entre ellas, si no que es el usuario el que decide en todo momento (exceptuando el tutorial) lo que quiere hacer.
...
![Mando_Xbox](https://github.com/ricfdzgon/Drivers_life/blob/main/Imagenes/MandoXbox.png){width='100px' height='100px'}
